...
#             newevent["MAGNITUDE_NOAA"] = event2["MAGNITUDE_NOAA"]
#             newevent["MAGNITUDE_HER"] = ""
#             newevent["LOCATION_NOAA"] = event2["LOCATION_NOAA"]
...
# mergedDF = getDFs(emptyDF, list1)
print(mergedDF)

# noaaDF.to_csv('noaaevs.csv', index=False)
# herDF.to_csv('herevs.csv', index=False)
# mergedDF.to_csv('mergedevs.csv', index=False)
